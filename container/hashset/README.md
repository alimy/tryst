...
## When to use hashset
Hashset **doesnt** guarantee concurrent safe. If you do need a concurrent safe set, go for skipset [link] -> https://github.com/alimy/tryst/tree/develop/collection/skipset
...
import (
	"fmt"
	"github.com/alimy/tryst/collection/hashset"
)
