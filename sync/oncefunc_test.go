...
func TestOnceValues(t *testing.T) {
	calls := 0
	f, _ := sync.OnceValues(func() (int, int) {
		calls++
...
func TestOnceFuncPanicTraceback(t *testing.T) {
	...
	f, _ := sync.OnceFunc(onceFuncPanic)
...
func TestOnceXGC(t *testing.T) {
	fns := map[string]func([]byte) (func(), func()){
		"OnceFunc": func(buf []byte) (func(), func()) {
			return sync.OnceFunc(func() { buf[0] = 1 })
		},
		"OnceValue": func(buf []byte) (func(), func()) {
			f, reset := sync.OnceValue(func() any { buf[0] = 1; return nil })
			return func() { f() }, reset
		},
		"OnceValues": func(buf []byte) (func(), func()) {
			f, reset := sync.OnceValues(func() (any, any) { buf[0] = 1; return nil, nil })
			return func() { f() }, reset
		},
	}
	for n, fn := range fns {
...
var (
	onceValue, _ = sync.OnceValue(func() int { return 42 })
